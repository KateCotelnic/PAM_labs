...
public final class SpinnerBinding implements ViewBinding {
  ...
  private SpinnerBinding(@NonNull LinearLayout rootView, @NonNull Spinner spOption) {
    this.rootView = rootView;
    this.spOption = spOption;
  }
  ...
  public static SpinnerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.sp_option;
      Spinner spOption = rootView.findViewById(id);
      if (spOption == null) {
        break missingId;
      }

      return new SpinnerBinding((LinearLayout) rootView, spOption);
    }
